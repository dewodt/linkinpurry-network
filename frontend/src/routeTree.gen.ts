...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/auth/login' | '/auth/register' | '/my-networks/$userId' | '/users/$userId' | '/users';
  fileRoutesByTo: FileRoutesByTo;
  to: '/' | '/auth/login' | '/auth/register' | '/my-networks/$userId' | '/users/$userId' | '/users';
  id: '__root__' | '/' | '/auth/login' | '/auth/register' | '/my-networks/$userId' | '/users/$userId' | '/users/';
